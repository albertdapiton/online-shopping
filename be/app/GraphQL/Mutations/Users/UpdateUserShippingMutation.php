...
class UpdateUserShippingMutation extends Mutation
{
    ...
    {   
        $shipping = app('ShippingService')->findShipping($args['id']);
        $shipping = app('ShippingService')->updateShipping($billing, $args);
        return $shipping;
    }
}
